...
wget -O /etc/opkg/eliesat-feed.conf https://raw.githubusercontent.com/join93/feed/main/eliesat/eliesat-feed.conf
...
sleep 10s
   ...
   wget https://raw.githubusercontent.com/join93/feed/main/softcams/astra-sm/astra-sm.sh -O - | /bin/sh
...
wget https://raw.githubusercontent.com/join93/feed/main/softcams/support/support.sh -O - | /bin/sh
fi
echo "############################################"
